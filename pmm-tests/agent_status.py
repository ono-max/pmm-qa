...
if __name__ == '__main__':
    ...
    for container in containerNames.splitlines():
        if "ps_" in container or "mysql_" in container or "pxc_" in container or "pgsql_" in containers or "rs10" in container or "haproxy_" in container or "redis_" in container or "external_" in container:
